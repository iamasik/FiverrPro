    ...
    for (let key in changes) {
        ...
        if (key === "naft") {
            ...
            if (storageChange.newValue > 0) {
                let notificationOptions = { type: "basic", title: "Fiverr Pro", message: "You have unread notifications.", iconUrl: "images/notification-icon.png" };
            ...
            if (storageChange.newValue > 0) {
                let notificationOptions = { type: "basic", title: "Fiverr Pro", message: "You have unread messages.", iconUrl: "images/notification-icon.png" };
                chrome.notifications.create(notificationOptions);
